...
public class XmlLibTest {
	...
	public void test() throws Exception {
        ...
        String description = generalConfig.getWebSiteInfo()
                                          .getDescription();
