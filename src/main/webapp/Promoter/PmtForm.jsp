			...
			<div class="col-md-9">
				...
				<div class="col-lg-12">
					...
					<div class="row">
						...
						<c:choose>
							<c:when test="${!empty updatePrmForm && updatePrmForm.promoter_id ne null }">

								<%-- 1. 회원정보 수정 --%>

								<form class='form-horizontal' method="post"
									action="/promoter/PrmUpdatePro.mwav">
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				...
																				<input class='form-control' name="pmtLoginId"
																					...
																					value="${updatePrmForm.prmLoginId }"
																					readonly="readonly" onchange="idcheck()"
																					required>
																			</div>
																		</div></td>
																	<td>
																		<input type="hidden" name="promoter_id" value="${updatePrmForm.promoter_id}" />														
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				...
																				<input class='form-control' name="prmLoginPw"
																					type='password' id="chkLoginPW"
																					value="${updatePrmForm.prmLoginPw }"
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				...
																				<input class='form-control' name="prmLogiNewPw"
																					type='password' id="chkLoginPW"
																					
0																					onchange="chkPWPolicy()"
																					required>
																			</div>
																		</div></td>
																</tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				...
																				<input class='form-control' name="prmLoginNewPw2"
																					type='password' id="chkLoginPW2"																					
																					onchange="chkPWPolicy()"
																					required>
																			</div>
																		</div></td>
																</tr>
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				...
																				<input class="form-control" name="prmNumber"
																					type="text" 
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				...
																				<select class='form-control' name="pmtBranch"
																					 required>
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				...
																				<select class="form-control" name="prmDeptName"
																					 required>
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				...
																				<select class="form-control" name="prmClass"
																					 required>
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				<input class="form-control" name="prmName"
																					value="${updatePrmForm.prmName}" type="text"
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				<input class="form-control" name="prmNickname"
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-5'>
																				<input class="form-control" name="pmtExtNbr"
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				<input class="form-control" name="prmPhone"
																					type="text" value="${updatePrmForm.prmPhone}" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
																					required />
																			</div>
																		</div></td>
																</tr>
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				<input class="form-control" name="prmCellularPhone"
																					type="text" value="${updatePrmForm.prmCellularPhone}"
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				<input class="form-control" name="prmMail"
																					id="chkEmail" type="text"
																					value="${updatePrmForm.prmMail}"
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				<input class="form-control" name="prmHomepage"
																					type="text"
																					placeholder="http:// " />
																			</div>
																		</div></td>
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-4'>
																				<input class="form-control" name="pmtSsn1"
																					type="text" maxlength="6"
																					 />
																			</div>
																			<div class='col-md-4'>
																				<input class="form-control" name="pmtSsn2"
																...
																<tr>
																	<td>등록일:</td>
																	<%-- <td>${updatePrmForm.pmtInsertDt}</td> --%>
																</tr>
																<tr>
																	<td>입사일:</td>
																	<%-- <td>${updatePrmForm.pmtJoinDt}</td> --%>
																</tr>
																<tr>
																	<td>부업무:</td>
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				<input class="form-control" name="pmtSubJobs"
							...
							주소</label>
																			...
																			<div class='col-md-8'>
																				<input class="form-control" id="Address"
																					...
																					value="${updatePrmForm.prmAddress}"
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				<input class="form-control" name="pmtBusinessPic"
																					type="file" />
																			</div>
																		</div></td>
																</tr>
												...
												<div class="panel-footer">
													...
													<button type="submit" id="modifyBuotton" onclick="mmodify()" class="btn btn-sm btn-primary">수정하기
													</button>							
													...
													<div class=" col-md-9 col-lg-9 ">
														...
														5. 영문 대문자와 소문자의 구분 ">
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				...
																				<input class="form-control" name="pmtNumber"
																					type="text"
																					onkeydown="filterNumber(event);" maxlength=10
																					required />
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				...
																				<select class="form-control" name="pmtDeptName"
																					required>
																					<option value="CEOs">CEOs</option>
																					<option value="관리">관리</option>
																					<option value="영업">영업</option>
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				...
																				<select class="form-control" name="pmtClass"
																					required>
																					<option value="0">*대기*</option>
																					<option value="05">임시</option>
																					<option value="10">사원</option>
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				<input class="form-control" name="pmtNickname"
																					type="text" maxlength="20" required />
																			</div>
																		</div></td>
																</tr>
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-5'>
																				<input class="form-control" name="pmtExtNbr"
																					type="text" maxlength="5" onkeydown="filterNumber(event);"/>
																			</div>
																		</div></td>
																</tr>
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-6'>
																				<input class="form-control" name="pmtPhone_1"
																					type="text" onkeydown="filterNumber(event);" maxlength="4" required />
																					 
																				<input class="form-control" name="pmtPhone_2" type="text"
																					maxlength="4" onkeydown="filterNumber(event);" maxlength="4" required /> 
																					 <input class="form-control" name="pmtPhone_3" type="text"
																					maxlength="4" onkeydown="filterNumber(event);" maxlength="4"required />
																			</div>
																		</div></td>
																</tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-3'>
																				<input class="form-control" name="pmtCellularP_1"
																					type="text" maxlength="4" onkeydown="filterNumber(event);" required />
																			</div>
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				<input class="form-control" name="pmtEmail"
																					id="chkEmail" type="text"
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				<input class="form-control" name="pmtHomepage"
						...
						<label><input type="radio" name="optradio" value="0">지번
							...
							주소</label>
																			...
																			<div class='col-md-8'>
																				<input class="form-control" name="pmtAddress_2" value=""
													...
													<div class="col-md-12 ">
														<div class='col-md-12 form-group center-block'>
															<textarea class="form-control" name="pmtMark"
																class="pmtMark" rows="15">가입되신것을 환영합니다.</textarea>
														</div>
