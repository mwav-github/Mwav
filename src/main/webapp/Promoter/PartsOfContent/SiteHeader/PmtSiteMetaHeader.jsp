...
<meta property="og:site_name" content="BizLogin.net" />
<meta property="og:type" content="website"/>
...
<meta name="Owner" content="BizLogin.net" />
<meta name="Author" content="Lewis,kim" />
<meta name="copyright" content="All contents are copyright by BizLogin.net" />
<meta name="distribution" content="global" />

<title>[BizLogin.net] >> Unleash your infinite possibilities with IT Optimization!!</title>
<!-- End of MetaTag Area -->	
	
	
<!-- Start of Head(CSS,JS) Area -->
<link href="/Promoter/zImage/logo_sample.jpg" rel="shortcut icon" type="image/x-icon">
<!-- jQuery -->
...
<!-- custom style -->
<link href="/Promoter/css/PmtCommons.css" rel="stylesheet" type="text/css"/>
<link href="/Promoter/css/PmtResponsive.css" rel="stylesheet" media="only screen and (max-width: 1200px)" />
<!-- custom javascript -->
