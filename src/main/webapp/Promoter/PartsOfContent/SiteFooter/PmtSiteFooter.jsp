		...
		<div class="row">
			<aside class="col-md-4 col-12">
				<article class="mr-md-4">
					...
					<ul class="list-icon">
						<li><i class="icon fa fa-map-marker"> </i>542 Fake Street,
							Cityname 10021 Netheerlends</li>
						<li><i class="icon fa fa-envelope"> </i> info@example.com</li>
						<li><i class="icon fa fa-phone"> </i> (800) 060-0730, (800)
							060-0730</li>
			...
			<aside class="col-md-4 col-12">
				...
				<div>
					...
					<a href="#" class="btn btn-icon btn-light"><i
						...
						class="btn btn-icon btn-light"><i class="fab fa-youtube"></i></a>
				</div>
