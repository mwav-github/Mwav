...
<!-- ========================= Head & Meta Area ========================= -->
<head>
	<jsp:include page="/Promoter/PartsOfContent/SiteHeader/PmtSiteMetaHeader.jsp"
		flush="false" />
...
<!-- ============================ COMPONENT LOGIN   ================================= -->
	<div class="card mx-auto" style="max-width: 380px; margin-top:50px;">
      ...
      <form>
          <a href="#" class="btn btn-kakao btn-block mb-2"> <i class="fab fa-facebook-f"></i> &nbsp  Sign in with Facebook</a>
          ...
          <div class="form-group">
          	<a href="#" class="float-right">Forgot ID/Password?</a> 
...
<footer class="section-footer border-top">
	<jsp:include page="/Promoter/PartsOfContent/SiteFooter/PmtSiteFooter.jsp"
		flush="false" />
</footer>
<!-- ========================= FOOTER END // ========================= -->
