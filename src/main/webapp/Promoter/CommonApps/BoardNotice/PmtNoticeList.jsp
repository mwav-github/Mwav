							...
							<ul class="pagination">
								...
								<c:forEach var="i" begin="${pagingVO.startPage}"
									...
									<li class="page-item"><a class="page-link"
										href="/CustomerService/Announcement/Announcement.mwav?pageNum=${i}">${i}<span
											class="sr-only">(current)</span></a></li>
								</c:forEach>
								<c:if test="${pagingVO.endPage < pagingVO.pageCount}">
									<li class="page-item"><a class="page-link"
										href="/CustomerService/Announcement/Announcement.mwav?pageNum=${pagingVO.startPage + pagingVO.pageBlock}">Next</a></li>
								</c:if>
							</ul>
						</nav>
					</div>
