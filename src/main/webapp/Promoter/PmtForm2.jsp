			...
			<div class="col-md-9">
				...
				<div class="col-lg-12">
					...
					<div class="row">
						...
						<c:choose>
							<c:when test="${!empty updatePmtForm && updatePmtForm.promoter_id ne null }">
...
0																					onchange="chkPWPolicy()"
																...
																<tr>
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				<input class="form-control" name="pmtPhone"
																					type="text" value="${updatePmtForm.pmtPhone}" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
																					required />
																			</div>
																		</div></td>
																</tr>
							...
							주소</label>
																			...
																			<div class='col-md-8'>
																				<input class="form-control" id="Address"
																					...
																					value="${updatePmtForm.pmtAddress}"
																	...
																	<td><div class='form-group'>
																			<div class='col-md-8'>
																				...
																				<input class='form-control' name="pmtLoginId"
																					...
																					onchange="idcheck('chkLoginId')" required>
																	<br>
