				...
				<div class="row no-gutters">
					<aside class="col-md-6">
						<article class="gallery-wrap">
							<div class="img-big-wrap">
								<div>
									<a href="#">
										<img src="https://www.inshopkorea.com/productFiles/0c5fb670c198bb4900ec4e01e08864fc.jpg">
									</a>
								</div>
							</div>
							<!-- .slider-product -->
					...
					<main class="col-md-6 border-left">
						<article class="content-body">
							...
							<div class="form-row">
								<div class="col">
									<a href="<c:url value="/bizlogin/goods/catalog/posting" />" class="btn btn-primary w-100">
										<span class="text">제품 포스팅 하기</span>
									</a>
								</div>
								<div class="col">
			...
			<article class="card">
				<div class="card-body">
					...
					<div class="text-center">
						<div>
							<a href="#">
								<img class="img-fluid" src="https://www.inshopkorea.com/productFiles/202009111738541249654822.jpg">
							</a>
						</div>
					</div>
				</div>
