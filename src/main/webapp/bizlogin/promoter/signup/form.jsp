	...
	<section class="section-content padding-y">
		<div class="card mx-auto" style="max-width: 520px; margin-top: 0px;">
			<article class="card-body">
				<header class="mb-4">
					<form action="<c:url value='/bizlogin/promoter/signup' />" method="POST" onsubmit="return pmtSubmit();">
						<div class="form-group">
							<label class="font-weight-bold" alt="Login ID">아이디</label>
							<input id="pmtLoginId" name="pmtLoginId" type="text" class="form-control"
						...
						<div class="form-group ">
							<label class="font-weight-bold" alt="Repeat password">비밀번호 확인</label>
							<input name="pmtLoginPwChk" id="pmtLoginPwChk" class="form-control" type="password"
						...
						<div class="form-group">
							...
							<input name="pmtFirstName" id="pmtFirstName" maxlength="20" onfocusout='validateCheck("pmtFirstName");'
								class="form-control" type="text" placeholder="성을 입력해주세요.">
						</div>
						<div class="form-group">
							<label class="font-weight-bold" alt="Name">이름(Last name)</label>
							<input name="pmtLastName" id="pmtLastName" maxlength="20" onfocusout='validateCheck("pmtLastName");'
								class="form-control" type="text" placeholder="이름을 입력해주세요.">
						</div>
						<div class="form-group">
							<label class="font-weight-bold" alt="Email">이메일</label>
							<input name="pmtMail" id="pmtMail" onfocusout='validateCheck("pmtMail");' type="email" class="form-control"
								placeholder="예)BizLogin12@biz.com">
						</div>
						<div class="form-group">
							<label class="font-weight-bold">휴대폰</label>
							<input name="pmtCellularPhone" type="text" onfocusout='validateCheck("pmtCellularPhone");' class="form-control"
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label class="custom-control custom-radio custom-control-inline">
									<input class="custom-control-input" checked="" type="radio" name="pmtGender" value="M">
									<span class="custom-control-label">남자 </span>
								</label>
								<label class="custom-control custom-radio custom-control-inline">
									<input class="custom-control-input" type="radio" name="pmtGender" value="F">
						...
						<div class="form-group">
							<label class="custom-control custom-checkbox">
								...
								<div class="custom-control-label">
									BizLogin의
									<a href="#" data-toggle="modal" data-target="#pmtPolicy">이용약관과 개인정보 취급방침</a>
									에 동의합니다. (필수)
								</div>
							</label>
						</div>
						<div class="form-group">
							<label class="custom-control custom-checkbox">
								...
								<div class="custom-control-label">신규 제품 및 이벤트 알림 SMS/메일 수신 (선택)</div>
							</label>
						</div>
						<div class="form-group">
							<button type="submit" class="btn btn-primary btn-block" alt="Register">가입하기</button>
		...
		<p class="text-center mt-4">
			이미 가입하셨나요.?
			<a href="<c:url value='/bizlogin/promoter/signin/form' />">로그인</a>
		</p>
		<br>
		<br>
	</section>
