					...
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-12">
								<br />
								<h4>
									<strong>회원 정보 - </strong><span class="badge badge-success">이메일 인증완료</span> <span class="badge badge-secondary">이메일
										인증 미완료</span>
								</h4>
								<hr>
								<br />
						...
						<div class="row">
								...
								<form>
									...
									<div class="form-group row">
										<label for="select" class="col-4 col-form-label">
											이메일 <span class="text-danger"><strong>*</strong></span>
										</label>
										<div class="col-8">
									...
									<div class="form-group row">
										...
										<div class="col-8">
											<input id="name" name="name" placeholder="이름" class="form-control here" type="text">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-8">
											<input id="text" name="text" placeholder="휴대폰 번호" class="form-control here" required="required" type="text">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-8">
											<input id="address" name="address" placeholder="주소" class="form-control here" required="required" type="text">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-8">
											<input id="postcode" name="postcode" placeholder="우편번호" class="form-control here" required="required"
												type="text">
										</div>
									</div>
									...
									<div class="form-group row">
										<div class="offset-4 col-8">
											<button name="submit" type="submit" class="btn btn-primary btn-md btn-block">회원정보 수정하기</button>
										</div>
									</div>
								</form>
							</div>
							...
							<div class="col-md-12">
								...
								<div class="form-group row">
									...
									<div class="col-8">
										<input id="bankname" name="bankname" placeholder="은행이름" class="form-control here" type="text">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-8">
										<div class="btn-group">
											<input id="accountholder" name="accountholder" placeholder="예금주" class="form-control here" type="text">

											<button type="button" class="ml-3 btn btn-secondary btn-block">예금주 조회</button>
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-8">
										<input id="accountnumber" name="accountnumber" placeholder="계좌번호" class="form-control here"
									...
									<table class="table table-hover text-center">
										...
										<tbody>
											<tr>
												...
												<td>
													<a href="#" class="btn btn-outline-primary btn-sm">연결 하기</a>
													<a href="#" class="btn btn-light btn-sm">연결 해제</a>
												</td>
											</tr>
											<tr>
												<td>
													<img src="https://blog.kakaocdn.net/dn/Sq4OD/btqzlkr13eD/dYwFnscXEA6YIOHckdPDDk/img.jpg"
														class="img-xs border">
												</td>
												<td>
													<p>mymg99@naver.com</p>
