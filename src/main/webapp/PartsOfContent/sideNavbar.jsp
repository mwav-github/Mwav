...
.navbar-twitch {
	position: fixed;
	top: 0px;
	right: 0px; /*left 하면 왼쪽으로 위에 padding 바꿔줘야 한다.*/
	width: 50px;
	height: 100%;
	border-radius: 0px;
	border: 0px;
...
.navbar-twitch .navbar-header,.navbar-twitch .navbar-brand {
	float: none;
	display: block;
	width: 100%;
	margin: 0px;
...
.navbar-twitch>.container .navbar-brand>.small-nav>span.logo,.navbar-twitch.open>.container .navbar-brand>.full-nav
	{
	display: block;
	font-weight: bold;
...
.navbar-twitch .tooltip,.navbar-twitch .tooltip .tooltip-inner {
	max-width: auto;
	white-space: nowrap;
}
...
.navbar-purple .navbar-brand,.navbar-purple .navbar-nav>li>a,.navbar-purple .navbar-brand:hover,.navbar-purple .navbar-nav>li>a:hover,.navbar-purple .navbar-brand:focus,.navbar-purple .navbar-nav>li>a:focus
	{
	color: rgb(205, 191, 227);;
}

.navbar-purple .navbar-brand:hover,.navbar-purple .navbar-nav>li>a:hover,.navbar-purple .navbar-brand:focus,.navbar-purple .navbar-nav>li>a:focus,.navbar-purple .navbar-nav>.active>a,.navbar-purple .navbar-nav>.active>a:hover,.navbar-purple .navbar-nav>.active>a:focus
	{
	background-color: rgb(111, 84, 153);
	color: rgb(255, 255, 255);
}
	...
	<div class="navbar navbar-default navbar-twitch" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				</span> <span class="full-nav"> < Bootsnipp > </span>
				</a>
			</div>
			<div class="">
...
<!-- 
http://bootsnipp.com/snippets/featured/twitch-like-navbar
