...
function editor_action(button_id) {
  ...
  // fgColor and bgColor
    ...
    var newcolor = showModalDialog(_editor_url + "popups/select_color.html", oldcolor, "resizable: yes; help: no; status: no; scroll: no;dialogheight:210px");
  ...
  // commandID and pass it to execCommand().   See http://msdn.microsoft.com/workshop/author/dhtml/reference/commandids.asp
    ...
    // insert image
      ...
      showModalDialog(_editor_url + "popups/insert_image.html", editdoc, "resizable: yes; help: no; status: no; scroll: no;dialogheight:220px");
    }
    ...
    // insert table
      ...
      showModalDialog(_editor_url + "popups/insert_table.html?"+objname,
                                 window,
                                 "resizable: yes; help: no; status: no; scroll: no;dialogheight:210px");
    }
...
function editor_setmode(objname, mode) {
  ...
  var RichEdit   = '<iframe ID="_' +objname+ '_editor"    style="width:' +editor_obj.style.width+ '; height:' +editor_obj.style.height+ '; border: 1px solid #6699ff;" frameborder="0"></iframe>';
