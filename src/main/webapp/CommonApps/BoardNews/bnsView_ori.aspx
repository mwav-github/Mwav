													...
													<tr vAlign="top" align="center" bgColor="#ffffff">
														<td>
															<table cellSpacing="2" cellPadding="1" width="98%" border="0">
																...
																<tr align="center">
																	<td><asp:label id="bNews_id" runat="server"></asp:label></td>
																	<td><asp:label id="bnsGroup" runat="server"></asp:label></td>
															...
															<table cellSpacing="0" cellPadding="0" width="98%" border="0">
																<tr>
																	<td align="left" bgColor="#166312" height="25"><asp:label id="bnsTitle" runat="server" CssClass="txt3" Font-Bold="True"></asp:label></td>
																</tr>
																<tr>
																	<td vAlign="top" align="left" height="200">
																		<div align="center" class="ContentBreak"><asp:label id="bnsSubTitle" runat="server"></asp:label></div>
																		<div align="left" class="ContentBreak"><asp:Label id="bnsContent" runat="server"></asp:Label></div>
																	</td>
																</tr>
																<tr>
