												...
												<table id="Table5" cellSpacing="0" cellPadding="0" width="100%" bgColor="#ffffff" border="1">
													<tr>
														<td height="300" align="center" vAlign="top">
															...
															<asp:datalist id="dlNewsList" runat="server">
																...
																<ItemTemplate>
																	<table width="450">
																		<TR align="center">
																			<TD>
																				<%# DataBinder.Eval(Container.DataItem, "bNews_id") %>
																			</TD>
																			<TD>
																				<%# DataBinder.Eval(Container.DataItem, "bnsGroup") %>
																			</TD>
																			<TD>
																				<a href='bnsView.aspx?cp=<%# WebUtil.CurrentRequest["cp"] %>&bnsID=<%# DataBinder.Eval(Container.DataItem, "bNews_id") %>&bnsG=<%# DataBinder.Eval(Container.DataItem, "bnsGroup") %>'>
																					<%# DataBinder.Eval(Container.DataItem, "bnsTitle") 	%>
																				</a>
																			</TD>
																			<TD>
																				<%# DataBinder.Eval(Container.DataItem, "newsDay", "{0:d}") %>
																			</TD>
																		</TR>
																	</table>
																</ItemTemplate>
															...
															<asp:label id="lbNews" runat="server" Visible="False" Height="50px">공지사항이 없습니다.</asp:label>
															<br>
