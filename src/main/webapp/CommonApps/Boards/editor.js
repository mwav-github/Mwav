...
document.write('.cMenu     { background-color: threedface; color: menutext; cursor: Default; font-family: ±º∏≤; font-size: 9pt; padding: 2 12 2 16; }');
document.write('.cMenuOver { background-color: highlight; color: highlighttext; cursor: Default; font-family: ±º∏≤; font-size: 9pt; padding: 2 12 2 16; }');
...
this.width =  "auto";
this.height = "auto";
this.bodyStyle = 'background-color: #FFFFFF; font-family: "±º∏≤"; font-size: 9pt;';
this.imgURL = _editor_url + 'Images/Toolbars/';
this.debug  = 0;
