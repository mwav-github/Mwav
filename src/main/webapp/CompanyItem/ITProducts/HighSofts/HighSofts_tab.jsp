			...
			<div class="mgtl3 col-md-8 ">
				...
				<div class="col-md-12">
					...
					<ul class="nav nav-pills nav-justified">
						<li role="presentation" class="active"><a data-toggle="tab" href="#DEMOS">
								<span>DEMOS</span>
						</a></li>
						<li role="presentation"><a data-toggle="tab" href="#FEATURES"><span>FEATURES</span></a></li>
						<li role="presentation"><a data-toggle="tab" href="#LICENSE_PRICING"><span>LICENSE/PRICING</span></a></li>
				...
				<div class="tab-content">
					...
					<div class="row tab-pane fade active in" id="DEMOS">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<img class="image-container img-thumbnail"
									data-original="/CompanyItem/ITProducts/Images/[1]_${item}_${demo_1}.svg"
									alt="Basic line"
									src="/CompanyItem/ITProducts/Images/[1]_${item}_${demo_1}.svg">
								<div class="enter"></div>

								<div class="text-center"
									onMouseOver="this.style.color='#58bb45'"
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<img class="image-container img-thumbnail"
									data-original="/CompanyItem/ITProducts/Images/[2]_${item}_${demo_2}.svg"
									alt="Basic line"
					...
					<div class="row tab-pane fade" id="FEATURES">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-9 col-md-9">
								...
								<p>It works in all modern mobile and desktop browsers
									...
									experience. Standard browsers use SVG for the graphics
									rendering. In legacy Internet Explorer graphics are drawn using
									VML.</p>
							</div>
							<div
						...
						<div class="row">
							<div
								...
								<p>
									Do you want to use ${item} for a personal website, a school
									site or a non-profit organisation? Then you don't need the
									author's permission, just go on and use ${item}. For commercial
									websites and projects, see
						...
						<div class="row">
							<div class="col-xs-12 col-sm-9 col-md-9">
								...
								<p>One of the key features of ${item} is that under any of
									the licenses, free or not, you are allowed to download the
									source code and make your own edits. This allows for personal
						...
						<div class="row">
							<div
								...
								<p>${item}issolelybasedonnativebrowsertechnologiesanddoesn't
									require client side plugins like Flash or Java. Furthermore you
									don't need to install anything on your server. No PHP or
									ASP.NET. ${item} needs only one JavaScript file to run</p>
							</div>
							<div
								class="col-xs-6 col-xs-offset-3 col-sm-3 col-sm-offset-0 col-sm-pull-9 col-md-3 col-md-offset-0 col-md-pull-9">
								<img class="thumbnail img-responsive" alt="Bootstrap template"
						...
						<div class="row">
							<div class="col-xs-12 col-sm-9 col-md-9">
								...
								<p>${item}supportsline,spline,area,areaspline,column,bar,pie,
									scatter, angular gauges, arearange, areasplinerange,
									columnrange and polar chart types. Many of these can be
						...
						<div class="row">
							<div
								...
								<p>Setting the ${item} configuration options requires no
									special programming skills. The options are given in a
									JavaScript object notation structure, which is basically a set
									of keys and values connected by colons, separated by commas and
									grouped by curly brackets.</p>
							</div>
							<div
								class="col-xs-6 col-xs-offset-3 col-sm-3 col-sm-offset-0 col-sm-pull-9 col-md-3 col-md-offset-0 col-md-pull-9">
								<img class="thumbnail img-responsive" alt="Bootstrap template"
						...
						<div class="row">
							<div
								...
								<p>Sometimes you want to compare variables that are not the
									...
									pressure. ${item} lets you assign an y axis for each series -
									or an x axis if you want to compare data sets of different
									categories. Each axis can be placed to the right or left, top
									or bottom of the chart. All options can be set individually,
						...
						<div class="row">
							<div class="col-xs-12 col-sm-9 col-md-9">
								...
								<p>On hovering the chart ${item} can display a tooltip text
									with information on each point and series. The tooltip follows
									as the user moves the mouse over the graph, and great efforts
									have been taken to make it stick to the nearest point as well
									as making it easy to read a point that is below another point.</p>
							</div>
							<div
								class="col-xs-6 col-xs-offset-3 col-sm-3 col-sm-offset-0 col-md-3 col-md-offset-0">
								<img class="thumbnail img-responsive" alt="Bootstrap template"
						...
						<div class="row">
							<div
								...
								<p>75% of all charts with an X and Y axis have a date-time X
									...
									the ticks so that they always mark the start of the month or
									the week, midnight and midday, the full hour etc.</p>
							</div>
							<div
								class="col-xs-6 col-xs-offset-3 col-sm-3 col-sm-offset-0 col-sm-pull-9 col-md-3 col-md-offset-0 col-md-pull-9">
								<img class="thumbnail img-responsive" alt="Bootstrap template"
						...
						<div class="row">
							<div
								...
								<p>By zooming in on a chart you can examine an especially
									interesting part of the data more closely. Zooming can be in
									the X or Y dimension, or both.</p>
							</div>
							<div
								class="col-xs-6 col-xs-offset-3 col-sm-3 col-sm-offset-0 col-sm-pull-9 col-md-3 col-md-offset-0 col-md-pull-9">
								<img class="thumbnail img-responsive" alt="Bootstrap template"
						...
						<div class="row">
							<div class="col-xs-12 col-sm-9 col-md-9">
								...
								<p>${item}takesthedatainaJavaScriptarray,whichcanbedefined
									in the local configuration object, in a separate file or even
									on a different site. Furthermore, the data can be handled over
									to ${item} in any form, and a callback function used to parse
									the data into an array.</p>
							</div>
							<div
								class="col-xs-6 col-xs-offset-3 col-sm-3 col-sm-offset-0 col-md-3 col-md-offset-0">
								<img class="thumbnail img-responsive" alt="Bootstrap template"
						...
						<div class="row">
							<div class="col-xs-12 col-sm-9 col-md-9">
								...
								<p>Cartesian chart types like line, area, spline or
									areaspline can be converted to polar or radial chart by one
									simple option.</p>
							</div>
							<div
								class="col-xs-6 col-xs-offset-3 col-sm-3 col-sm-offset-0 col-md-3 col-md-offset-0">
						...
						<div class="row">
							<div
								...
								<p>Sometimes you need to flip over your chart and make the X
									axis appear vertical, like for example in a bar chart.
									Reversing the axis, with the highest values appearing closest
									to origo, is also supported.</p>
							</div>
							<div
								class="col-xs-6 col-xs-offset-3 col-sm-3 col-sm-offset-0 col-sm-pull-9 col-md-3 col-md-offset-0 col-md-pull-9">
								<img class="thumbnail img-responsive" alt="Bootstrap template"
						...
						<div class="row">
							<div class="col-xs-12 col-sm-9 col-md-9">
								...
								<p>All text labels, including axis labels, data labels for
									the point and axis titles, can be rotated in any angle.</p>
							</div>
							<div
								class="col-xs-6 col-xs-offset-3 col-sm-3 col-sm-offset-0 col-md-3 col-md-offset-0">
								<img class="thumbnail img-responsive" alt="Bootstrap template"
					...
					<%--license / price --%>
					<div class="row tab-pane fade" id="LICENSE_PRICING">
						<h2 class="text-center mgb3" style="color: #78828D;">
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<div class="col-md-12">
											...
											<p>
												<strong><span class="price">USD 660.00</span></strong>
											</p>
										</div> -->
											<div class="clearfix"></div>
										</div>
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<div class="col-md-12">
											...
											<ul>
												<li>Allows Highcharts, Highstock and Highmaps to be
													used in SaaS projects, web applications, intranets, and
													websites.</li>
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<div class="col-md-12">
											...
											<div class="col-md-8">
												<p>Choose this licence if you are bundling Highcharts
													with hardware and/or software solutions designed to be
													hosted or operated by your clients. E.g. Intranets and
													other behind-the-firewall hosting scenarios, appliances,
													IoT devices or other embedded systems.</p>
											</div>
											<div class="col-md-4 text-center">
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<div class="col-md-12">
											...
											<p>
												If you are current ${item} version 4.0 user, <br>you
												may update your license in order to get access to ${item} 5.
											</p>
								...
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
											...
											<tr>
												<td>Guaranteed initial response time of 36 hours,
													working days</td>
