		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="row">
					...
					<div
						class="col-xs-6 col-xs-offset-3 col-sm-8 col-sm-offset-2 col-md-2 col-md-offset-0">
					...
					<div class="col-xs-12 col-sm-12 col-md-12">
						...
						<div class="col-xs-6 col-sm-6 col-md-2">
							<img class="img-responsive"
								src="/CompanyItem/ITProducts/Images/trustwave.png" alt="trustwave"
								data-toggle="tooltip" data-placement="top"
				...
				<div class="row">
					...
					<div
						class="col-xs-6 col-xs-offset-3 col-sm-8 col-sm-offset-2 col-md-2 col-md-offset-0">
						<img class="thumbnail img-responsive" alt="security"
					...
					<div class="col-xs-8 col-xs-offset-2 col-md-12 ">
						...
						<div class="col-xs-12 col-md-4">
							<img class="img-responsive"
								src="/CompanyItem/ITProducts/Images/sitelock_large-300x58.png"  alt="sitelock"/>
							<br>
						</div>
						<div class="col-xs-12 col-md-4">
							<img class="img-responsive"
								src="/CompanyItem/ITProducts/Images/sitelock_large_911.png"  alt="sitelock. 9-1-1" />
							<br>
						</div>
						<div class="col-xs-12 col-md-4">
							<img class="img-responsive"
								src="/CompanyItem/ITProducts/Images/geotrustlogo_horizontal.png" alt="geotrustlogo" />
							<br>
						</div>
					</div>
				...
				<div class="row">
					...
					<div
						class="col-xs-6 col-xs-offset-3 col-sm-8 col-sm-offset-2 col-md-2 col-md-offset-0">
						<img class="thumbnail img-responsive" alt="domain"
					...
					<div class="col-md-12">
						<div class="col-xs-4 col-md-4">
							<img class="img-responsive"
								src="/CompanyItem/ITProducts/Images/lightbulb.png" alt="lightbulb"
								data-toggle="tooltip" data-placement="top"
								data-original-title="Name Suggestion" />
						</div>
						<div class="col-xs-4 col-md-4">
							<img class="img-responsive"
								src="/CompanyItem/ITProducts/Images/gears.png" alt="gears"
								data-toggle="tooltip" data-placement="top"
								data-original-title="Managed DNS" />
						</div>
						<div class="col-xs-4 col-md-4">
							<img class="img-responsive"
								src="/CompanyItem/ITProducts/Images/support.png" alt="support"
								data-toggle="tooltip" data-placement="top"
					...
					<div class="col-md-12">
						<div class="col-xs-4 col-md-4">
							<img class="img-responsive"
								src="/CompanyItem/ITProducts/Images/private.png" alt="private"
								data-toggle="tooltip" data-placement="top"
								data-original-title="Contact Privacy" />
						</div>
						<div class="col-xs-4 col-md-4">
							<img class="img-responsive"
								src="/CompanyItem/ITProducts/Images/keys.png" alt="keys"
								data-toggle="tooltip" data-placement="top"
						...
						<div class="col-xs-4 col-md-4">
							<img class="img-responsive"
								src="/CompanyItem/ITProducts/Images/network.png" alt="network"
								data-toggle="tooltip" data-placement="top"
