...
-->
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="text-center">
					<h1 style="color: #04A3ED;">What Is Microsoft Office 2021?</h1>
					<hr>
				</div>
				...
				<div class="col-md-12">
					...
					<p>
						...
						365 Personal, Office Home & Student 2021, Office Home & Business
						2021, Office Professional 2021 등의 Microsoft Office를 제작한 회사입니다.
						...
						단축키를 비롯하여 Microsoft Office 2016의 강력한 소프트웨어가 Microsoft Office 2021에
						그대로 남아 있습니다. Office 2021에서는 클라우드에 있는 문서를 열어 수정, 저장하거나 협업을 할 수 있기
						때문에 효율성을 극대화하고 언제 어디서든 일을 처리할 수 있습니다. Microsoft Office는 Open
						Office나 Google Docs와 같은 무료 소프트웨어와 비교해 훨씬 강력하며, 보다 나은 지원 서비스를
						제공합니다. <br> <br>Office Home & Student 2016, Office Home
						& Business 2016, Office Professional 2016 등 이전 버전의 Office를 갖고 계신다면
						Office 365 또는 Office 2021으로 업그레이드할 때가 되었습니다. Microsoft Office 제품을
 ...
 -->
				...
				<div class="row">
					<div class="col-md-12">
						<p>Office 365에는 새로운 Office 2021 버전의 Word, Excel, PowerPoint 등이
							포함되어 있습니다.</p>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-6">
						<h3 class="text-left mgb3" style="color: #04A3ED;">Word 2021</h3>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-md-pull-6">
						<h3 class="text-left mgb3" style="color: #04A3ED;">Excel 2021</h3>
