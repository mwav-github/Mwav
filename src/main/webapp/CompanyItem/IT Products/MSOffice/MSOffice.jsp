				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<p>
							...
							단축키를 비롯하여 Microsoft Office 2013의 강력한 소프트웨어가 Microsoft Office
							2016에 그대로 남아 있습니다. Office 2016에서는 클라우드에 있는 문서를 열어 수정, 저장하거나 협업을 할
							수 있기 때문에 효율성을 극대화하고 언제 어디서든 일을 처리할 수 있습니다. Microsoft Office는 Open
							Office나 Google Docs와 같은 무료 소프트웨어와 비교해 훨씬 강력하며, 보다 나은 지원 서비스를
							제공합니다. <br> <br>Office Home & Student 2013, Office Home
							& Business 2013, Office Professional 2013 등 이전 버전의 Office를 갖고
							계신다면 Office 365 또는 Office 2016으로 업그레이드할 때가 되었습니다. Microsoft
							Office 제품을 살펴보고 사용자의 개인적 필요나 비즈니스 필요에 맞는 완벽한 솔루션을 찾으십시오. <br>
							<br>
					</div>
				</div>
