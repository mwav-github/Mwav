			...
			<div class="col-md-9">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-12" style="color: #78828D;">
						<p>어떤 회사라도 조직차트, 회사조직도 또는 조직도표를 만들고 공유할 필요가 있습니다. <br/>
						       조직 구성도를 시각화할 최적의 대안은 찾기 쉽지 않지만, 자사의 OrgChart 소프트웨어를 이용하면 필요한 정보를 시각화하여
							빠르게 얻을 수 있습니다. 회사 규모는 실제 중요하지 않습니다. 직원 수가 50명이던 50,000명이던 OrgChart
							소프트웨어를 통해 가능합니다. <br/>
							많은 회사들이 조직도를 구성하고 직원 능력 수치를 시각화하는 등 가장 쉽고 정확한 방식으로써 자사의 OrgChart 소프트웨어 솔루션을 신뢰하고 있습니다.</p>
						<br />
					</div>
				</div>
				...
				<div class="row pgtb7">
					...
					<div
						...
						<p>OrgChart Platinum을 통하여 더욱 큰 통찰력을 가지고 인력관리를 할 수 있습니다. 조직변경의 높은 투명성과 정밀한 모델변경 시나리오를 계획하세요.</p>
					</div>
					<div
				...
				<div class="row pgtb7" style="background-color: #f2f2f2;">
					<div class="col-xs-12 col-sm-7 col-md-7" style="color: #78828D;">
						...
						<p>또한 OrgChart Now에 필요한 것은 웹브라우저 뿐입니다. – 다운로드하여 설치 또는 어떤 것도 세팅할 필요가 없습니다. 한 개의 팀 또는 전체 조직을 위한 조직구성차트 소프트웨어를 찾고 있다면, 바로 OrgChart Now는 그런 여러분의 요구사항을 충족시키고 더불어 필요에 따라 확장되도록 설계되었습니다.</p>
					</div>
					<div
				...
				<div class="row pgtb7">
					...
					<div
						...
						<p>OrgChart Enterprise는 최상의 차트 및 인원계획 솔루션입니다.레이아웃,컨텐츠 및 디자인에 있어 최상의 유연성을 보장합니다.유명 HR 시스템과 직접적인 통합을 통해 조직 차트와 시각화를 빠르게 구성하고 유지할 수 있습니다.</p>
					</div>
					<div
						class="col-xs-6 col-xs-offset-3 col-sm-5 col-sm-offset-0 col-sm-pull-7 col-md-5 col-md-offset-0 col-md-pull-7">
				...
				<div class="row pgtb7" style="background-color: #f2f2f2;">
					<div class="col-xs-12 col-sm-7 col-md-7" style="color: #78828D;">
						...
						<p>OrgChart Professional는 급여 및 성과율 등과 같은 주요 HR측정항목을 포괄하여 맞춤 차트를 구성하는데 유용합니다. OrgChart Professional는 보다 큰 인사이트와 적은 시간으로 인력관리를 할 수 있게 합니다.</p>
					</div>
					<div
						class="col-xs-6 col-xs-offset-3 col-sm-5 col-sm-offset-0 col-md-5 col-md-offset-0">
				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header" style="color: #78828D;">어느 Org Chart 소프트웨어 제품이 귀사에 가장 적합할까요?</h3>
					</div>
