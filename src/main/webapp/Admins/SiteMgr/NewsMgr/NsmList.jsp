...
<body>
	<table width="1000" border="0" align="center" cellpadding="0"
		...
		<tr>
			...
			<td width="10">&nbsp;</td>
			<td valign="top">&nbsp; <%-- 세번째--%>
			<form name="NtmList" method="post" action="/HomePage/N_View.do">
										...
										<td valign="top" align="center" height="300">
											<table height="49" cellspacing="0" cellpadding="0"
												...
												<tr>
													<td width="204"><img height="49"
														src="/HomePage/Admins/SiteMgr/zImages/admin_news_001.gif"
														width="204" /></td>
													<td
																	...
																	<table cellspacing="0" cellpadding="0" width="100%"
																		...
																		<tr>
																			<td width="64%"><select name="ddlSearch">
																				...
																				<option value="bnGroup">분류</option>
																				<option value="staff_id">작성자</option>
																				<option value="bnContent">내용</option>
																				</select>  
																				<input type="text" name="tbSearchString" maxlength="8" value="검색 키워드" size="25" /> 
																				<input type="hidden" name="searchflag" value="false" /> <%--List.jsp 한번이라도 호출시 => searchflag는 false --%>
																				<input name="btnSearch" type="submit" value="검색" />
																				<%--검색창 http://javaclass1.tistory.com/95http://www.devpia.com/Maeul/Contents/Detail.aspx?BoardID=56&MaeulNo=22&no=66203&ref=66203--%>
																			</td>
											...
											<c:if test="${count > 0}">
												<table width="800" cellpadding="2" cellspacing="1">
													...
													<tr height="30">
														<td align="center" width="55">${article.news_id}  </td>
														<td align="center" width="70">${article.bnGroup}</td>
														<td align="center" width="171">${article.bnTitle}</td>
														<td align="center" width="83">${article.bnWriteDt}</td>
														<td align="center" width="91">${article.staff_id}</td>
														<td align="center" width="89">${article.bnViewCount}</td>
														<td align="center" width="74">${article.bnOrder}</td>				
														<td width="124" align="center">
															<button type="button" name="hlAllView" style="border: solid 0px #FFFFFF;"
																onclick="javascript:window.location.href='/HomePage/N_View.do?news_id=${article.news_id}'">
											...
											<table cellspacing="0" cellpadding="0" width="800" border="0">
												<tr>
													...
													<td align="center"></td>
													<td align="center">
														<button type="button" name="hlAllList" style="border: solid 0px #FFFFFF;"
														...
														<button type="button" name="hlInsert" style="border: solid 0px #FFFFFF;"
															onclick="javascript:window.location.href='/HomePage/N_WriteForm.do'">
        	...
        	<c:if test="${startPage > pageBlock}">
        		<a href="/HomePage/N_List.do?pageNum=${startPage - pageBlock}">[이전]</a>
        		<input type = "hidden" name ="pageNum" value ="${startPage - pageBlock}"/>
        	</c:if>
        	<c:forEach var="i" begin="${startPage}" end="${endPage}">
        	<a href="/HomePage/N_List.do?pageNum=${i}">[${i}]</a>
        	</c:forEach>
        	<c:if test="${endPage < pageCount}">
        		<a href="/HomePage/N_List.do?pageNum=${startPage + pageBlock}">[다음]</a>
        	</c:if>
        </c:if>
		<tr>
			<td>&nbsp;</td>
