					...
					<table cellspacing="0" cellpadding="0" width="810" border="0">
						...
						<tr>
							<td bgcolor="#ffffff"><table width="100%" border="0"
									...
									<tr>
										<td width="160"><img
											src="/HomePage/Admins/SiteMgr/zImages/admin_news_003.gif"
											height="53" /></td>
										<td
						...
						<tr valign="top" align="center" bgcolor="#ffffff">
							<td height="300"><table cellspacing="2" cellpadding="1"
									...
									<tr>
										...
										<td>&nbsp;</td>
										<td>&nbsp;</td>
										<td><select name="buStatus" value="${bnStatus}">
									...
									<tr align="center">
										...
										<td><select align="center" width="20%" name="bnGroup"
											value="${article.bnGroup}">
											...
											<table cellspacing="1" cellpadding="3" width="600" border="0">
												<tr bgcolor="#ffffff">
													...
													<td width="484" align="left"><input type="text"
														Width="450px" MaxLength="200" name="bnTitle"
														value="${article.bnTitle}"></td>
												</tr>
												<tr bgcolor="#ffffff">
													<td align="center" bgcolor="#3a8bb1">부제목</td>
													<td width="484" align="left"><input type="text"
														name="bnSubTitle" Width="450px" rows="2" maxlength="500"
														value="${article.bnSubTitle }"></td>
												</tr>
											</table></td>
									</tr>
									<tr>
											...
											<table cellspacing="1" cellpadding="3" width="800" border="0">
												<tr>
													...
													<td align="left" colspan="3"><textarea
															name="bnContent" cols="150" rows="80">${article.bnContent}</textarea>
														<script type="text/javascript">
															//<![CDATA[
															CKEDITOR
																	.replace('bnContent');
