                  ...
                  <td><table width="600" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td colspan="3"> <% if MbrID = "" then %> <input name="MbrID" type="text" id="MbrID" value="<%= MbrID %>" size="15" maxlength="15" style="ime-mode:inactive">
                          &nbsp;&nbsp; <input type="button" name="btnMbrID" value="중복확인" onClick="javascript:IDcheckExists('vMember',frmMbr.MbrID,'Yes','../../CommonAccessories/IDSeek/IDseekWithXML.asp');">
...
<% Call CheckDetailOption("vBuyableItems", "bwText", "bwText", "bIDX", Split(buyable,"&nbsp;")) %>
                      ...
                      <tr bgcolor="#E0FFC1">
                        <td height="20">&nbsp;</td>
                        <td colspan="3" bgcolor="#E0FFC1">직장정보
                          <% if company = "" or IsNull(company) then Response.Write(" - 가입시 입력하지 않았씀") end if%>
                          (최소기입사항- 회사명, 업무, 전화번호)</td>
                      </tr>
                      <tr>
