       ...
       <c:forTokens var="mbrCellularP" items="${mbrCellularP}" delims="-">
        <input name="mbrCellularP" type = "text" value="${mbrCellularP}"   maxlength="4" size="3"/>&nbsp;
            ...
            <c:forEach var="Option1" items="${Option }">                                                    <tr>
																	<td class="Bwhite" style="height: 22px"
																		bgcolor="#3a8bb1" height="22">&nbsp;연락전화번호</td>
																	<td style="height: 22px">&nbsp; ${Option1.mbrPhone} &nbsp;
																...
																<tr>
																	<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																		&nbsp;주민등록번호</td>
																	<td>&nbsp; ${Option1.mbrSsn1} - ${Option1.mbrSsn2}
																	</td>
																</tr>
																<tr>
																	<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																		&nbsp;주소</td>
																	<td>&nbsp; ${Option1.mbrAddress}
																	</td>
																</tr>
																<tr>
																	<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																		&nbsp;뉴스레더신청</td>
																	<td>&nbsp; ${Option1.mbrMailing}
																	</td>
																</tr>
																<tr>
																	<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																		&nbsp;PW찾기질문</td>
																	<td>&nbsp; ${Option1.mbrFindingId}
																	</td>
																</tr>
																<tr>
																	<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																		&nbsp;PW찾기답</td>
																	<td>&nbsp; ${Option1.mbrFindingA}
																	</td>
																</tr>
																<tr>
																	<td class="Bwhite" bgcolor="#3a8bb1" height="22">
														...
														<table cellspacing="1" cellpadding="2" width="100%"
															...
															<c:forEach var="Value" items="${Value }">
																...
																<tr>
																	<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																		&nbsp;누적구매액/횟수</td>
																	<td>&nbsp; ${Value.mbrHowMuch} &nbsp;/ ${Value.mbrHowMany}
																	</td>
																</tr>
																<tr>
																	<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																		&nbsp;현재/누적적립금&nbsp;</td>
																	<td>&nbsp; ${Value.mbrRsvFund} &nbsp;/ ${Value.mbrRsvFundAc}
																	</td>
																</tr>
																<tr>
																	<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																		&nbsp;현재/누적포인트</td>
																	<td>&nbsp; ${Value.mbrPoint} &nbsp;/ ${Value.mbrPointAc}
																	</td>
																</tr>
																<tr>
																	<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																...
																<tr>
																	<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																		&nbsp;누적미지불금액</td>
																	<td>&nbsp; ${Value.mbrUnpaidAc}
																	</td>
																</tr>
																<tr>
																	<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																		&nbsp;추천인ID</td>
																	<td>&nbsp; ${Value.mbrRcmderId}
																	</td>
																</tr>
																<tr>
																	<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																...
																<td valign="top">
																	<table cellspacing="1" cellpadding="2" width="100%"
																		...
																		<tr>
																			<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																				&nbsp;홈페이지</td>
																			<td colspan="3">&nbsp; ${Option.mbrHomepage}
																			</td>
																		</tr>
																		<tr>
																			<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																				&nbsp;메신져</td>
																			<td colspan="3">&nbsp; ${Option.mbrNickname}
																			</td>
																		</tr>
																		<tr>
																			<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																				&nbsp;취미&nbsp;</td>
																			<td colspan="3">&nbsp; ${Option.mbrHobbies}
																			</td>
																		</tr>
																		<tr>
																			<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																				&nbsp;차량정보</td>
																			<td colspan="3">&nbsp; ${Option.mbrCarInfo}
																			</td>
																		</tr>
																		<tr>
																			<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																				&nbsp;생일</td>
																			<td>&nbsp; ${Option.mbrCarInfo}
																			</td>
																			<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																				&nbsp;결혼기념일</td>
																			<td>&nbsp; <input type="text"
																		...
																		<tr>
																			<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																				&nbsp;월급</td>
																			<td>&nbsp; ${Option.mbrMonthlyPay}
																			</td>
																			<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																				&nbsp;자녀수</td>
																			<td>&nbsp; ${Option.mbrChildren}</td>
																		</tr>
																		<tr>
																			<td class="Bwhite" bgcolor="#3a8bb1" height="22">&nbsp;
		...
		<td>
																		...
																		<tr>
																			<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																				&nbsp;회사명</td>
																			<td colspan="3">&nbsp; ${Job.mbrCompany}										</td>
																		</tr>
																		<tr>
																			<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																				&nbsp;직업명</td>
																			<td colspan="3">&nbsp; ${Job.mbrJobType}</td>
																		</tr>
																		<tr>
																			<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																				&nbsp;연락번호</td>
																			<td colspan="3">&nbsp; ${Job.mbrOfficePhone}
																			</td>
																		</tr>
																		<tr>
																			<td class="Bwhite" bgcolor="#3a8bb1" height="22">
																				&nbsp;회사주소</td>
																			<td colspan="3">&nbsp; ${Job.mbrOfficeAddress}
