	...
	<div class="modal fade modalUploadImages" id="modalUploadImages">
		<div class="modal-dialog">
			<div class="modal-content">
				<form id="insertFileForm" method="post" enctype="multipart/form-data" role="form" action="/common/fileUpLoader.mwav">
							...
							<div class="input-group image-preview">
								...
								<span class="input-group-btn"> <!-- image-preview-clear button -->
									...
									<div class="btn btn-default image-preview-input">
										<span class="glyphicon glyphicon-folder-open"></span> <span class="image-preview-input-title">Browse</span> <input type="file" accept="image/png, image/jpeg, image/gif" name="input-file-preview" />
										<!-- rename it -->
									</div>
								</span>
							</div>
