...
<table width="1000" border="0" align="center" cellpadding="0"
  ...
  <tr>
    ...
    <td valign="top" >&nbsp;
      <%-- 세번째--%>
      <form name="GdsCaRelation" method="post" action="/HomePage/GdsCaRelationPro.do">
        <table cellSpacing="0" cellPadding="0" width="815" border="0">
          ...
          <tr vAlign="top" align="center" bgColor="#ffffff">
            <td height="150"><table cellSpacing="0" cellPadding="0"
              ...
              <table cellSpacing="0" cellPadding="0" width="780" border="0">
                <tr>
                  <td vAlign="top" align="center" width="150" height="200">&nbsp;</td>
                  ...
                  <td vAlign="top" align="center" rowSpan="2"><table
                      ...
                      <tr>
                        <td class="Bwhite" align="center" bgColor="#3a8bb1">상품유일코드</td>
                        <td align="left">&nbsp;
                          <input name="Goods_id"
                      ...
                      <tr>
                        <td class="Bwhite" align="center" bgColor="#3a8bb1">카테고리ID</td>
                        <td align="left">&nbsp;
                          <c:if test="${count>0}">
                          
                          <select name="gCategory_id" class="box003"><c:forEach var="categorykey" items="${categorykey }">
          ...
          <tr>
            <td align="center" bgcolor="#ffffff" height="31"><button type="button" name="hiList"
									style="border: solid 0px #FFFFFF;"
									onclick="javascript:window.location.href='/HomePage/GdsCellList.do'"> <img src="/HomePage/Admins/zImages/btn_view_list.gif"
										border="0"> </button>
              <button type="button" name="hiBack"
									style="border: solid 0px #FFFFFF;"
									onClick="javascript:history.go(-1)"> <img src="/HomePage/Admins/zImages/btn_admin_back.gif"
										border="0"> </button>
              <button type="submit" name="iblInsert"
									style="border: solid 0px #FFFFFF;"> <img src="/HomePage/Admins/zImages/admin_btn_enter.gif"
										border="0"> </button></td>
          </tr>
        </table>
        <div id="ValidationSummary1"
						style="color: Red; height: 17px; width: 163px; Z-INDEX: 101; LEFT: 624px; POSITION: absolute; TOP: 24px; display: none;"> </div>
      </form></td>
  </tr>
  <tr>
    <td colspan="3" >&nbsp;
