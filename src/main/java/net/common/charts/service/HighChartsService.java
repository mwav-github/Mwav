...
public class HighChartsService {
    ...
    public DataVO selectListWeeklyUsers() {
        ...
        //String[] categories = new String[] {"Mont", "14 Feb '13","15 Mar '13","11 Apr '13","19 May '13","23 Jun '13","3 Jul '13","8 Aug '13","5 Sep '13","17 Oct '13","23 Nov '13","5 Dec '13"};
	...
	public DataVO selectListTop10Page() {
        ...
        //String[] categories = new String[] {"Mont", "14 Feb '13","15 Mar '13","11 Apr '13","19 May '13","23 Jun '13","3 Jul '13","8 Aug '13","5 Sep '13","17 Oct '13","23 Nov '13","5 Dec '13"};
        return new DataVO("chart4-container", "Top10 PageList", "통계", "Run Dates", "column" ,Arrays.asList(page), list_2);
    }
	...
	public DataVO selectListClientScreenSize() {
        ...
        //String[] categories = new String[] {"Mont", "14 Feb '13","15 Mar '13","11 Apr '13","19 May '13","23 Jun '13","3 Jul '13","8 Aug '13","5 Sep '13","17 Oct '13","23 Nov '13","5 Dec '13"};
        return new DataVO("chart5-container", "ClientScreenSize", "통계", "Run Dates", "pie" ,Arrays.asList(page), list_2);
   }
