...
public class Common_Util {
    ...
    public Common_Util() { returnString = new StringBuffer(); }
    public Common_Util(int len) { returnString = new StringBuffer(); this.setLength(len); }
    public Common_Util(String type) { returnString = new StringBuffer(); this.setType(type); }
    public Common_Util(int len, String type) { returnString = new StringBuffer(); this.setLength(len); this.setType(type); }
    public Common_Util(String type, int len) { returnString = new StringBuffer(); this.setType(type); this.setLength(len); }
