...
public class CustomMapArgumentResolver implements HandlerMethodArgumentResolver{
	/*	supportsParameter 메서드는 Resolver가 적용 가능한지 검사하는 역할을 하고, 
     ...
     *  CommandMap 클래스 참조 ! CommandMap 객체를 생성하였다. 
            그 다음으로, request에 담겨있는 모든 키(key)와 값(value)을 commandMap에 저장하였다.  
        request에 있는 값을 iterator를 이용하여 하나씩 가져오는 로직이다. 
            마지막으로 모든 파라미터가 담겨있는 commandMap을 반환하였다.
     * */
	@Override
