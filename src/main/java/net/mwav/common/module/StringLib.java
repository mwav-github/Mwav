...
public class StringLib {
	 ...
	 * 빈 문자열 <code>""</code>.
	 */
	private static StringLib stringLib;
	private StringLib(){}
	
	public static synchronized StringLib getInstance(){
		if(stringLib ==null){
	 ...
	 *
	 * @param strString
	 * @return HTML 태그를 치환한 문자열 (xss 스크립트 방지)
	 */
	...
	/**
	     * 특수문자를 웹 브라우저에서 정상적으로 보이기 위해 특수문자를 처리('<' -> & lT)하는 기능이다 (xss스크립트)
	     * @param 	srcString 		- '<'
	     * @return 	변환문자열('<' -> "&lt"
	     * @exception MyException
	     * @see
