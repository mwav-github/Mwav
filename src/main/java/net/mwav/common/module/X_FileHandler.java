...
public class X_FileHandler {
     ...
     * @param filePath
     */
    public X_FileHandler(MultipartHttpServletRequest multipartRequest, String filePath) {
     ...
     * @param multipartRequest
     */
    public X_FileHandler(MultipartHttpServletRequest multipartRequest) {
        this.multipartRequest = multipartRequest;
     ...
     * @return this
     */
    public X_FileHandler setUpload(MultipartHttpServletRequest multipartRequest, String filePath) {
        this.multipartRequest = multipartRequest;
        this.filePath = filePath;
        fileNames = new HashMap<String, List<String>>();
        return this;
     ...
     * @return this
     */
    public X_FileHandler setUpload(MultipartHttpServletRequest multipartRequest) {
        this.multipartRequest = multipartRequest;
        this.filePath = multipartRequest.getSession().getServletContext().getRealPath("/resources/tempfile");
        fileNames = new HashMap<String, List<String>>();
        return this;
     ...
     * @param saveNameCreate
     */
    public void upload(boolean saveNameCreate) {
     ...
     * @param oldName
     */
    public X_FileHandler(HttpServletResponse response, String filePath, String saveName, String oldName) {
     ...
     * @return this
     */
    public X_FileHandler setDown(HttpServletResponse response, String filePath, String saveName, String oldName) {
        this.response = response;
        this.filePath = filePath + "/" + saveName;
        this.oldName = oldName;
        return this;
     ...
     * @param saveName
     */
    public X_FileHandler(String filePath, String saveName) {
        this.filePath = filePath + "/" + saveName;
    }
    /**
     * delete setter
     ...
     * @return this
     */
    public X_FileHandler setDelete(String filePath, String saveName) {
        this.filePath = filePath + "/" + saveName;
        return this;
    }
    /**
